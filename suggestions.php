...
$india_states = [
    ...
    "Karnataka"=>["Bagalkot","Bangalore Rural","Bangalore Urban","Belagavi","Ballari","Bidar","Chamarajanagar","Chikballapur","Chikkamagaluru","Chitradurga","Dakshina Kannada","Davanagere","Dharwad","Gadag","Hassan","Haveri","Kalaburagi","Kodagu","Kolar","Koppal","Mandya","Mysuru","Raichur","Ramanagara","Shimoga","Tumakuru","Udupi","Uttara Kannada","Vijayapura","Yadgir"],
    ...
    "Punjab"=>["Amritsar","Barnala","Bathinda","Faridkot","Fatehgarh Sahib","Fazilka","Ferozepur","Gurdaspur","Hoshiarpur","Jalandhar","Kapurthala","Ludhiana","Mansa","Moga","Muktsar","Pathankot","Patiala","Rupnagar","S.A.S. Nagar","Sangrur","Tarn Taran"],
    "Rajasthan"=>["Ajmer","Alwar","Banswara","Baran","Barmer","Bharatpur","Bhilwara","Bikaner","Bundi","Chittorgarh","Churu","Dausa","Dholpur","Dungarpur","Hanumangarh","Jaipur","Jaisalmer","Jalore","Jhalawar","Jhunjhunu","Jodhpur","Karauli","Kota","Nagaur","Pali","Pratapgarh","Rajsamand","Sawai Madhopur","Sikar","Sirohi","Sri Ganganagar","Tonk","Udaipur"],
    "Sikkim"=>["East Sikkim","North Sikkim","South Sikkim","West Sikkim"],
    "Tamil Nadu"=>["Ariyalur","Chengalpattu","Chennai","Coimbatore","Cuddalore","Dharmapuri","Dindigul","Erode","Kallakurichi","Kanchipuram","Kanyakumari","Karur","Krishnagiri","Madurai","Nagapattinam","Namakkal","Nilgiris","Perambalur","Pudukkottai","Ramanathapuram","Ranipet","Salem","Sivaganga","Tenkasi","Thanjavur","Theni","Thoothukudi","Tiruchirappalli","Tirunelveli","Tirupattur","Tiruppur","Tiruvallur","Tiruvarur","Vellore","Viluppuram","Virudhunagar"],
...
// Country list
$countries = ["India","United States","United Kingdom","Canada","Australia","Germany","France","Italy","Japan","China"];

// Prepare suggestions
$suggestions = [];

if($type == 'state'){
    foreach($india_states as $state=>$districts){
        if(stripos($state,$term)!==false) $suggestions[]=$state;
    }
}
elseif($type=='district'){
    foreach($india_states as $state=>$districts){
        foreach($districts as $district){
            if(stripos($district,$term)!==false) $suggestions[]=$district;
        }
    }
}
elseif($type=='country'){
    foreach($countries as $country){
        if(stripos($country,$term)!==false) $suggestions[]=$country;
    }
}
